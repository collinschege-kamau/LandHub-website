...
<head>
    ...
    /* This targets mobile phones */
        @media (max-width: 600px) {
            ...
            /* Ensure buttons don't stay glued to the right edge */
            .edit-profile-btn, .logout-btn {
                position: static !important; /* Disables absolute positioning if used */
                width: fit-content;
            }
        }
    ...
    <div class="header-container">
        <header style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 25px;">
            ...
            <div style="display: flex; gap: 20px; align-items: center;">
                ...
                <?php if($user_id): ?>
                    <div style="display: flex; gap: 10px; align-items: center; flex_direction: column;">
