...
<head>
    ...
    <style>
        ...
        .profile-btn { display: inline-block; padding: 8px 18px; background-color: var(--primary-blue); color: white; text-decoration: none; border-radius: 20px; font-size: 0.85rem; font-weight: 600; transition: all 0.3s ease; border: 2px solid transparent; }
        .profile-btn:hover { background-color: white; color: var(--primary-blue); border-color: var(--primary-blue); transform: translateY(-2px); box-shadow: 0 4px 8px rgba(0,0,0,0.1); }
        .profile-btn i { margin-right: 5px; }
        @media (max-width: 600px) {
            .header-container { display: flex; flex-direction: column; align-items: center; text-align: center; gap: 15px; width: 100%; overflow: hidden; }
            .card { width: 95% !important; margin: 10px auto; box-sizing: border-box; }
        }
        .header-wrapper { display: flex; flex-wrap: wrap; justify-content: space-around; align-items: center; gap: 10px; padding: 10px; width: 100%; box-sizing: border-box; }
        .action-buttons { display: flex; gap: 10px; justify-content: center; width: 100%; margin-top: 5px; }
    </style>
</head>
<body>
...
<div class="container">
    <div class="header-container">
        ...
        <div>
           <label style="font-size: 1.85rem; font-weight: bold;">Search for your perfect land</label> 
        </div>
        <section>
                ...
                <div class="card <?php echo $isSold ? 'is-sold' : ''; ?>">
                    ...
                    <div class="btn-group">
                        ...
                        <?php else: ?>
                            ...
                            <a href="https://wa.me/<?php echo $wa_phone; ?>" target="_blank" class="action-btn btn-wa"><i class="fa-brands fa-whatsapp"></i> WhatsApp</a>
                        <?php endif; ?>
                    </div>
                </div>
            <?php endwhile; ?>
